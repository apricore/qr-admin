...
![Editor](https://img.shields.io/badge/Editor-CodeMirror%205-orange)
...
- File explorer with project root
- CodeMirror editor with syntax highlighting
- File creation / rename actions
- ZIP compress & extract workflow
- Live preview iframe (HTML / PHP)

Add images under a `screenshots/` directory and reference them here:
